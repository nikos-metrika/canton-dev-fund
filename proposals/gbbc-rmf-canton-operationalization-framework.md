...
![Structured RMF Assessment Framework](./rmf-assessment-framework.png)
...
![Example Canton protocol-level KRIs and operational monitoring views focused on validator participation, uptime, Super Validator visibility, and operational resilience](./canton-kri-monitoring.png)
...
![Real-Time Monitoring Framework](./real-time-monitoring-framework.png)
